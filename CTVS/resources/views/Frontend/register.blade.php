        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 py-5 pr-md-5">
                    ...
                    <form action="{{ url('/web/patient_store') }}" method="POST" class="appointment-form ftco-animate">
                        @csrf
                        ...
                        <div class="d-md-flex">
                            ...
                            <div class="form-group ml-md-4">
                                <input type="email" value="{{ old('patient_email') }}" name="patient_email" class="form-control" placeholder="Email">
                                @error('patient_email')
                                    <p class="alert alert-danger">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="d-md-flex">
                            ...
                            <div class="form-group ml-md-4">
                                <input type="number" value="{{ old('phone') }}" name="phone" class="form-control" placeholder="Pnone">
                                @error('phone')
                                <p class="alert alert-danger">{{ $message }}</p>
                                @enderror
                            </div>
