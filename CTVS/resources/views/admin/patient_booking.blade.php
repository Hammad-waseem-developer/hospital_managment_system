    ...
    <div class="QA_table mb_30">
        ...
        <table class="table lms_table_active">
            ...
            <tr>
                ...
                <th class="text-warning fw-bold" scope="col">Reject</th>
            </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="{{url('/admin/pending_appointment')}}/{{$item->appointment_id}}" class="btn btn-primary text-white">Reject</a></td>
